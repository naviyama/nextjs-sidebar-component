      ...
      <div className={`flex flex-col text-white h-screen ${isMobile? 'fixed z-20' : 'md:static'} md:bg-black md:w-1/6 md:overflow-y-auto lg:w-1/5`}>
        {isMobile && (
          <div 
            ...
            className='flex flex-col justify-center items-end bg-gray-300 bg-opacity-60 rounded-md hover:bg-opacity-90 hover:bg-black z-10'
          >
            {!showModal && (
              <button className='p-4 text-black text-2xl hover:text-white'>
                <MdMenu />
              </button>
            )}
          </div>
